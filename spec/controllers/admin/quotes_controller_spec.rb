...
require_dependency 'admin/quotes_controller'
class Admin::QuotesController < Admin::ResourceController; def rescue_action(e); raise e; end end

describe Admin::QuotesController do
  # Uses Admin::ResourceController, built into Radiant
  dataset :users, :quotes
  ...
  [:admin, :developer].each do |user|
    describe "#{user} user" do
      ...
      def redirects_to_index
        ...
        response.should redirect_to(admin_quotes_path)
      end
